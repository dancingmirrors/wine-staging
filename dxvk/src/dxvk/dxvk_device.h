...
namespace dxvk {
  ...
  private:
    ...
    // Use smaller recycler sizes on 32-bit platforms to reduce memory pressure
    DxvkRecycler<DxvkCommandList,    env::is32BitHostPlatform() ? 4 : 16> m_recycledCommandLists;
    DxvkRecycler<DxvkDescriptorPool, env::is32BitHostPlatform() ? 4 : 16> m_recycledDescriptorPools;
