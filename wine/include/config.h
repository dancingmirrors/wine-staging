...
/* Define to 1 if you have the <libavcodec/bsf.h> header file. */
#define HAVE_LIBAVCODEC_BSF_H 1
...
#define PACKAGE_STRING "Wine 11.0-rc2"
...
#define PACKAGE_VERSION "11.0-rc2"
...
#define SONAME_LIBEGL "libEGL.so.1"
...
#define SONAME_LIBNETAPI "libnetapi.so.1"

/* Define to the soname of the libodbc library. */
#define SONAME_LIBODBC "libodbc.so.2"
