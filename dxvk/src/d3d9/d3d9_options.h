...
namespace dxvk {
  ...
  struct D3D9Options {
    ...
    /// Force hide the hardware cursor.
    /// Useful for games with ENB mods that render their own software cursor,
    /// which can cause a "double cursor" issue.
    bool forceHideHardwareCursor;
  };
