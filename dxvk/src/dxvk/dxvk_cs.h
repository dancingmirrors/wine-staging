...
namespace dxvk {
  ...
  public:
    ...
    /**
     * \brief Trims the chunk pool
     *
     * Releases all cached chunks to reduce memory pressure.
     * Should be called when the system is idle or under
     * memory pressure, especially on 32-bit platforms.
     */
    void trim();
